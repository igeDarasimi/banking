...
const AuthForm = ({type}: {type:string}) => {
    ...
    const formSchema = authFormSchema(type);
        ...
        const onSubmit = async (data: z.infer<typeof formSchema>) => {
           ...
           try {
            // here we are signing up with appwrite & creating plaid token
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    {type === 'sign-up' && (
                        <>
                         ...
                         <div className='flex gap-4'>
                         <CustomInput 
                         control={form.control} name="state" label="State" placeholder="Example: Oyo State"
                         />

                         <CustomInput 
                         control={form.control} name="postalCode" label="Postal Code" placeholder="Example: 210102"
                         />
                        </div>  
                        ...
                        <div className='flex gap-4'>
                          <CustomInput 
                             control={form.control} name="dateOfBirth" label="Date of birth" placeholder="YYYY-MM-DD"
                              />
                          <CustomInput 
                              control={form.control} name="ssn" label="SSN" placeholder="1234"
                            /> 
                        </div>
